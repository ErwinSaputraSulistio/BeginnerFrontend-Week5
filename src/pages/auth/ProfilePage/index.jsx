...
export default class ProfilePage extends Component {
   ...
   componentDidMount(){
      ...
      .then((res) => {this.setState({inputData: res.data.outputData[0], updateRealName: res.data.outputData[0].realName, updateUserJobs: res.data.outputData[0].userJobs})})
   ...
   updateHandleSubmit = (e) => {
      ...
      if(this.state.passwordVerification === this.state.inputData.userPassword){
         ...
         .then(() => {
            alert("Berhasil memperbarui data akun dari " + this.state.updateRealName + ", refresh page untuk melihat perubahan!")
   ...
   eraseHandleSubmit = (e) => {
      ...
      if(this.state.eraseInput === "HAPUS"){
         // const paramsId = this.props.match.params.id
         axios.delete(process.env.REACT_APP_USER + localStorage.getItem("userId"))
         .then(() => {
                     ...
                     <div className="userUpdateZone">
                        ...
                        <form className="updateForm" onSubmit={this.updateHandleSubmit}>
                           ...
                           <div className="updateInputBorder">
                              <input className="mulishFont updateInput" type="text" id="updateName" name="updateRealName" placeholder="Change your name here ..." value={this.state.updateRealName} onChange={this.updateChangeHandler} required/>
                           </div>
                           ...
                           <div className="updateInputBorder marginBottomUserJobs">
                              <input className="mulishFont updateInput" type="text" id="updateTitle" name="updateUserJobs" placeholder="Change your title here ..." value={this.state.updateUserJobs} onChange={this.updateChangeHandler} required/>
                           </div> 
